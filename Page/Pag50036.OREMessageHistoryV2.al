page 50036 "ORE Message History V2"
{
    ...
    ModifyAllowed = false;
    PageType = List;
    SourceTable = "ORE Message History V2";
        ...
        area(processing)
        {
            group(History)
            {
                ...
                action("Cancel Message")
                {
                    ...
                    trigger OnAction()
                    begin
                        IF NOT CONFIRM('Are you sure to cancel this message?') THEN
                            EXIT;
                        ...
                        CASE Rec."Message Name" OF
                            'ORDERS':
                                BEGIN
                                    ...
                                    PAGE.RUN(50037, OREMessageCollectionORDERS);
                                END;
                            'ORDCHG':
                                BEGIN
                                    OREMessageCollectionORDCHG.RESET;
                                    ...
                                    PAGE.RUN(50065, OREMessageCollectionORDCHG);
                                END;
                            'INVRPT':
                                BEGIN
                                    OREMessageCollectionINVRPT.RESET;
                                    ...
                                    PAGE.RUN(50066, OREMessageCollectionINVRPT);
                                END;
                            'SLSRPT':
                                BEGIN
                                    OREMessageCollectionSLSRPT.RESET;
                                    ...
                                    PAGE.RUN(50096, OREMessageCollectionSLSRPT);
                                END;
                        END;
                    end;
                }
