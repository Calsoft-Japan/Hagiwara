page 50089 "Sales Ship&Inv Import Lines"
{

    ApplicationArea = All;
    UsageCategory = Lists;
    Editable = false;
    Caption = 'Sales Ship & Invoice Import Lines';
    DeleteAllowed = false;
    Description = 'Sales Ship & Invoice Import Lines';
    InsertAllowed = false;
    ModifyAllowed = false;
    PageType = List;
    ...
    actions
    {
        area(creation)
        {
            ...
            action("Post Ship & Invoice")
            {
                ...
                trigger OnAction()
                var
                    RptPostInv: Report "SO Post Ship & Invoice";
                begin
                    InvoiceLine.RESET;
                    IF NOT InvoiceLine.FINDFIRST() THEN
            ...
            REPEAT
                ...
                IF ErrMsg = '' THEN
                    REPEAT
                        ...
                        ValidateSOLine.SetTransType(TransType::ShipInvoice, RecRef, FRef.NAME);
