pageextension 56630 SalesRtnOrdExt extends "Sales Return Order"
{
    layout
    {
        ...
        addbefore("P&osting")
        {
            group("Hagiwara Approval")
            {
                action("Submit")
                {
                    ...
                    begin
                        recApprSetup.Get();
                        if not recApprSetup."Sales Return Order" then
                            exit;
                        ...
                        cuApprMgt.Submit(enum::"Hagiwara Approval Data"::"Sales Return Order", Rec."No.", UserId);
                    end;
                }
                action("Cancel")
                {
                    ...
                    begin
                        ...
                        cuApprMgt.Cancel(enum::"Hagiwara Approval Data"::"Sales Return Order", Rec."No.", UserId);
                    end;
                }
                action("Hagi Approve")
                {
                    ...
                    begin
                        ...
                        cuApprMgt.Approve(enum::"Hagiwara Approval Data"::"Sales Return Order", Rec."No.", UserId);
                    end;
                }
                action("Hagi Reject")
                {
                    ...
                    begin
                        ...
                        cuApprMgt.Reject(enum::"Hagiwara Approval Data"::"Sales Return Order", Rec."No.", UserId);
                    end;
                }
                action("Update")
                {
                    ...
                    begin
                        ...
                        cuApprMgt.Update(enum::"Hagiwara Approval Data"::"Sales Return Order", Rec."No.", UserId);
                    end;
                }
                action("Approval Entries")
                {
                    ...
                    begin
                        ...
                        recApprEntry.SetRange(Data, Enum::"Hagiwara Approval Data"::"Sales Return Order");
    ...
    begin
        //N005 Begin
        recApprSetup.Get();
        if recApprSetup."Sales Return Order" then begin
