report 50029 "Sales Invoice HEH"
{
    // CS067 Shawn 01/18/2024 - Hagiwara HEH Upgrade.(US format Based)
    // CS092 FDD R054 Bobby.ji 2025/7/24 - Upgrade to the BC version
    DefaultLayout = RDLC;
    RDLCLayout = './RDLC/Sales Invoice HEH.rdlc';

    Caption = 'Sales Invoice HEH';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyAddr; CompanyInfo3.Address)
                    {
                    }
                    column(CompanyAddr2; CompanyInfo3."Address 2")
                    {
                    }
