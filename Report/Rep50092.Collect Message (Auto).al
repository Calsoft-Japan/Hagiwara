report 50092 "Collect Message (Auto)"
{
    // Modification:
    // 1. SH 04 Nov 2012 - Insert algorithm to validate PSI process job sequence
    // 2. SH 20171021
    //    - Remove Request Page Navigation Conrol
    //    - Collect Daily and Monthly PSI data together
    //    - Remove all dispays
    // 
    ...
    begin
        ...
        //Start v20201112. Set value as 2 when there exist SalesPrice error.
        GRec_GLSetup."Monthly PSI Data Collection" := '1';
        ...
        //SH 20171021 - Remove Message Display
        //IF g_optRetrieveType = g_optRetrieveType::Daily THEN BEGIN
    ...
    begin
        ...
        //IF g_optRetrieveType = g_optRetrieveType::Daily THEN BEGIN
        //   IF GRec_GLSetup."Daily PSI Data Collection" = '1' THEN BEGIN
        ...
        //Collect Purchase Receipt
        g_optRetrieveType := g_optRetrieveType::Monthly;
        //IF (bln_MessageID[5])  (RequestOptionsPagechk_JJEDITABLE) THEN BEGIN
