table 50114 "Vendor Import Line"
{
    fields
    {
        ...
        field(47; "Cash Flow Payment Terms Code"; Code[10])
        {
        }
        field(48; "Primary Contact No."; Code[20])
        {
        }
        ...
        field(51; "Lead Time Calculation"; DateFormula)
        {
        }
        field(52; "ID No."; Text[13])
        {
        }
        field(53; "Shipping Terms"; Text[100])
        {
        }
        field(54; "Incoterm Code"; Code[20])
        {
        }
        field(55; "Incoterm Location"; Text[50])
        {
        }
        field(56; "Manufacturer Code"; Code[10])
        {
        }
        field(57; "ORE Reverse Routing Address"; Code[40])
        {
        }
        field(58; "Excluded in ORE Collection"; Boolean)
        {
        }
        field(59; "ORE Reverse Routing Address SD"; Code[40])
        {
        }
        field(60; "Hagiwara Group"; Code[10])
        {
        }
        field(61; "Familiar Name"; Code[20])
        {
        }
        field(62; "Pay-to Address"; Text[50])
        {
        }
        field(63; "Pay-to Address 2"; Text[50])
        {
        }
        field(64; "Pay-to City"; Text[30])
        {
        }
        field(65; "Pay-to Post Code"; Code[20])
        {
        }
        field(66; "Pay-to County"; Text[30])
        {
        }
        field(67; "Pay-to Country/Region Code"; Code[10])
        {
        }
        field(68; "Exclude Check"; Boolean)
        {
        }
        field(69; "Update PO Price Target Date"; Option)
        {
        ...
        field(73; "Error Description"; Text[250])
        {
        }
        field(74; "Action"; Option)
        {
